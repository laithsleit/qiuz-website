var questions = [
    {
        question: "Which operator is used for strict equality (both value and type) in JavaScript?",
        choices: [
            "===",
            "==",
            "=",
...
submitButton.addEventListener("click", function () {
    ...
    if (score >= questions.length / 2) {
        resultContainer.innerHTML = '<div class="message pass"><p>You Passed<p></div>';
    } else {
        resultContainer.innerHTML = '<div class="message fail"><p>You Failed<p></div>';
    }
